...
export function ShopTab({ keys, openChest, isOpening, recentResults, onCloseResults }: ShopTabProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {chests.map(chest => (
          <div key={chest.id} className="bg-white rounded-3xl p-6 border border-gray-100 shadow-md flex flex-col items-center text-center">
            <div className={`w-24 h-24 rounded-full bg-linear-to-br ${chest.color} flex items-center justify-center text-5xl shadow-inner mb-4`}>
              {chest.icon}
            </div>
            ...
            <div className="flex gap-2 w-full mt-auto">
              <button 
                ...
                disabled={isOpening || keys[chest.id] < 1}
              ...
              <button 
                ...
                disabled={isOpening || keys[chest.id] < 10}
